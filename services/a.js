async function generateReport(kabupaten, tahun, baseDir) {
    try {
        ...
        SELECT 
            ...
            COALESCE(e.desa, v.desa) AS desa,
        ...
        LEFT JOIN erdkk e ON combined.nik = e.nik
        ...
        LEFT JOIN verval_summary v ON combined.nik = v.nik
        ...
        LEFT JOIN tebusan_per_bulan t ON combined.nik = t.nik
